...
const Header_05 = () => {
  ...
  return (
    <HeaderContent className={`fixed top-0 left-1/2 transform -translate-x-1/2 z-10 w-full transition-all duration-300 ${isScrolled ? "bg-white bg-opacity-80" : "bg-transparent"}`}>
    <div
